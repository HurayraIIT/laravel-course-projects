...
class Menu
{
    ...
    private function add_category(): void
    {
    ...
    private function view_categories(): void
    {
        $cat = new Categories();
        $cat->view_categories();
    }

    private function add_income(): void
    {
    ...
    private function view_incomes(): void
    {
        $inc = new Income();
        $inc->view_income();
    }

    private function add_expense(): void
    {
    ...
    private function view_expenses(): void
    {
        $exp = new Expense();
        $exp->view_expense();
    }

    private function view_savings(): void
    {
        $inc = new Income();
